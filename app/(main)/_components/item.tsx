    ...
    >
        ...
        {isSearch && (
            ...
            bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground opacity-100">
                <span className="text-xs">⌘</span>Mr
            </kbd>
        )}
        {!!id && (
...
<DropdownMenu>
  <DropdownMenuTrigger asChild>
    <div
      ...
      onClick={(e) => e.stopPropagation()} // Prevents triggering parent click events
    >
      <MoreHorizontal className="h-4 w-4" />
    </div>
  </DropdownMenuTrigger>
  <DropdownMenuContent
    className="w-64 p-2 bg-white dark:bg-neutral-800 rounded-md shadow-md"
    align="start"
    side="right"
    alignOffset={8}
    forceMount
  >
    ...
    <div className="text-xs text-muted-foreground px-2">
      Additional information or actions here.
    </div>
  </DropdownMenuContent>
</DropdownMenu>
